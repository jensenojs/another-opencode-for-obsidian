...
function createObsidianAppearanceStyle(): string {
  ...
  html[data-another-opencode-for-obsidian-workspace-background="enabled"] body::before {
    display: block;
  }
    ...
    html[data-another-opencode-for-obsidian-appearance="obsidian"][data-another-opencode-for-obsidian-workspace-background="enabled"] dialog::backdrop {
      -webkit-backdrop-filter: none !important;
      backdrop-filter: none !important;
    }
  ...
  (function() {
        ...
        if (!value.variables || typeof value.variables !== 'object' || Array.isArray(value.variables)) return false;
          return Object.keys(value.variables).every(function(name) {
            return /^--[-_a-zA-Z0-9]+$/.test(name) &&
              !/^--another-opencode-for-obsidian-editor-background-/.test(name) &&
    ...
    return {
      ...
      function collectInjectionState() {
        return {
          bridgeScriptCount: document.querySelectorAll('script[data-another-opencode-for-obsidian-bridge]').length,
          appearanceStyleCount: document.querySelectorAll('style[data-another-opencode-for-obsidian-appearance]').length,
          themeScriptCount: document.querySelectorAll('script[data-another-opencode-for-obsidian-theme]').length,
        ...
        var observer = new MutationObserver(function(mutations) {
          ...
          function sourceBoundary() {
            ...
            var workspaceBackgroundState = style.getPropertyValue(
              '--another-opencode-for-obsidian-workspace-background-state'
            ).trim();
